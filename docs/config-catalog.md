...
Source: [`packages/client/ui-vn/src/index.ts:15`](../packages/client/ui-vn/src/index.ts)
...
- `@deepseek-ai/dsh-experimental-imouto-dev-process` — requires `tools` ([`packages/experimental/imouto-dev-process/src/index.ts`](../packages/experimental/imouto-dev-process/src/index.ts))
