/**
 * Profile-local maintenance operations for the optional OpenAI Codex bundle.
 * A dsh profile owns the process; this module only exposes `run()` to it.
 * @module @stellarie/dsh-imouto-codex/bin
 */
