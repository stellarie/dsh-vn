...
// The developer machine's installed Codex cache must not decide the catalog.
vi.stubEnv(
  'DSH_CODEX_MODELS_CACHE',
  fileURLToPath(new URL('./fixtures/no-codex-cache.json', import.meta.url)),
)
import {
