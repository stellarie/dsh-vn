...
Technical prose follows ASD-STE100. Use active voice and simple tenses. Keep one instruction per sentence, at most 20 words. Use one word for one meaning. This rule covers docs, comments, commits, PR text, and reports. The [dsh-prose-standard](.agents/skills/dsh-prose-standard/SKILL.md) and the word budgets win any conflict.
