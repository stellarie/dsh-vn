 ...
 * ui-settings-models, ui-vn, ui-settings-plugins, ui-agent-preset, and
 * ui-settings-unarchive-sessions. A plugin adding a section changes this list.
 */
const PRODUCT_SECTIONS: readonly string[] = ['general', 'models', 'visual-novel', 'plugins', 'agent-presets', 'archived-sessions']
